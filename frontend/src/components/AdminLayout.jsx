...
import { 
  ...
  LogOut, ChevronDown, User, Settings, X // Added X for closing modal
} from 'lucide-react';
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="text-left hidden sm:block">
                  <p className="text-xs font-black text-slate-800 leading-none capitalize">{adminUser.username || "Admin"}</p>
              ...
              {isProfileOpen && (
                <div className="absolute right-0 mt-3 w-64 bg-white rounded-[24px] shadow-2xl border border-slate-50 py-3 z-50 animate-in fade-in slide-in-from-top-2">
                  <div className="px-5 py-3 border-b border-slate-50 mb-2">
                    ...
                    <p className="text-xs font-bold text-slate-700 truncate">{adminUser.email || "No Email Provided"}</p>
                  </div>
                  
                  {/* UPDATED PROFILE BUTTON */}
                  <button 
                    onClick={() => { setIsModalVisible(true); setIsProfileOpen(false); }}
                    className="flex items-center gap-3 px-5 py-2.5 w-full text-slate-600 hover:bg-indigo-50 text-sm font-bold transition-all text-left"
                  >
            ...
            <div className="text-center">
              ...
              <div className="bg-slate-50 rounded-3xl p-6 text-left space-y-4 mb-8">
                <div>
                  ...
                  <p className="text-sm font-bold text-slate-700 truncate">{adminUser.email || "Not Provided"}</p>
                </div>
                <div>
