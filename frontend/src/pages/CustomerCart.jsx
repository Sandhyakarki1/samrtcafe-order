            ...
            cart.map(item => (
              <div key={item.id} className="bg-white p-5 rounded-[35px] shadow-sm border border-white flex flex-col gap-4">
                ...
                <div className="relative">
                  <input 
                    className="w-full bg-slate-50 border-none rounded-xl p-3 pl-10 text-[11px] font-medium outline-none"
        ...
        {cart.length > 0 && (
          <div className="bg-white p-8 rounded-[45px] shadow-2xl border border-white">
            ...
            <div className="flex flex-col gap-3">
                ...
                >
                <Banknote size={18} className="text-emerald-500" /> Pay with Cash
                </button>
            </div>
          </div>
        )}
